    ...
    <div class="container">
      ...
      <script type="text/javascript">
    	$(function () {
    		...
    		yAxis: {
    			...
    			series: [{
            name: 'Forecasting',
            data: [2711198,2.1917184,8504630]
    			}, {
            name: 'Albacore',
            data: [0,<?= $alb ;?>,<?= $alb2;?>]
    			}, {
      ...
      <div class="col-md-12">
        <div class="jumbotron" style="text-align: justify; border-radius: 0; margin-top: 15px; padding: 40px;">
          ...
          digunakan metode MAD, MSE, dan MAPE yang menghasilkan nilai MAD : <?php echo $mad; ?>, MSE : <?php echo $mse; ?> dan MAPE : <?php echo number_format($mape, 2)."%"; ?> yang berarti permalan data raw material
          tahunan PT. Pahala Bahari Nusantara menggunakan metode <i>Exponential Smoothing</i> adalah metode yang tepat karena Persentase keakuratannya <?php echo 100 - number_format($mape, 2)."%"; ?>.
        </div>
      </div>
    </div>
